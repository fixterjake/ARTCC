...
public class EventsController : ControllerBase
{
    ...
    [HttpPost]
    [Authorize(Roles = Constants.PERMISSION_CREATE_EVENT)]
    ...
    public async Task<ActionResult<Response<Event>>> CreateEvent(Event data)
    {
        try
        {
            if (!await _redisService.ValidatePermissions(Request.HttpContext.User, new string[] { Constants.PERMISSION_CREATE_EVENT }))
    ...
    public async Task<ActionResult<Response<Event>>> GetEvent(int eventId)
    {
        try
        {
            var getClosed = await _redisService.ValidatePermissions(Request.HttpContext.User, new string[] { Constants.PERMISSION_VIEW_CLOSED_EVENTS });
    ...
    [HttpPut]
    [Authorize(Roles = Constants.PERMISSION_UPDATE_EVENT)]
    [ProducesResponseType(typeof(Response<Event>), 200)]
    [ProducesResponseType(typeof(Response<IList<ValidationFailure>>), 400)]
    [ProducesResponseType(401)]
    [ProducesResponseType(403)]
    ...
    public async Task<ActionResult<Response<Event>>> UpdateEvent(Event data)
    {
        try
        {
            if (!await _redisService.ValidatePermissions(Request.HttpContext.User, new string[] { Constants.PERMISSION_UPDATE_EVENT }))
                return StatusCode(401);
    ...
    [HttpDelete]
    [Authorize(Roles = Constants.PERMISSION_DELETE_EVENT)]
    ...
    public async Task<ActionResult<Response<string?>>> DeleteEvent(int eventId)
    {
        try
        {
            if (!await _redisService.ValidatePermissions(Request.HttpContext.User, new string[] { Constants.PERMISSION_DELETE_EVENT }))
                return StatusCode(401);
    ...
    [HttpPost("Positions")]
    [Authorize(Roles = Constants.PERMISSION_CREATE_EVENT_POSITION)]
    ...
    public async Task<ActionResult<Response<EventPosition>>> CreateEventPosition(EventPosition data)
    {
        try
        {
            if (!await _redisService.ValidatePermissions(Request.HttpContext.User, new string[] { Constants.PERMISSION_CREATE_EVENT_POSITION }))
                return StatusCode(401);
    ...
    public async Task<ActionResult<Response<IList<EventPosition>>>> GetEventPositions(int eventId)
    {
        try
        {
            if (!await _redisService.ValidatePermissions(Request.HttpContext.User, new string[] { Constants.PERMISSION_VIEW_CLOSED_EVENTS }))
            {
    ...
    [Authorize(Roles = Constants.PERMISSION_DELETE_EVENT_POSITION)]
    [ProducesResponseType(typeof(Response<string?>), 200)]
    [ProducesResponseType(401)]
    [ProducesResponseType(403)]
    [ProducesResponseType(typeof(Response<string?>), 404)]
    ...
    public async Task<ActionResult<Response<string?>>> DeleteEventPosition(int eventPositionId)
    {
        try
        {
            if (!await _redisService.ValidatePermissions(Request.HttpContext.User, new string[] { Constants.PERMISSION_DELETE_EVENT_POSITION }))
                return StatusCode(401);
    ...
    [Authorize(Roles = Constants.PERMISSION_CREATE_EVENT_REGISTRATION)]
    ...
    public async Task<ActionResult<Response<EventRegistration>>> CreateEventRegistration(EventRegistration data)
    {
        try
        {
            if (!await _redisService.ValidatePermissions(Request.HttpContext.User, new string[] { Constants.PERMISSION_CREATE_EVENT_REGISTRATION }))
                return StatusCode(401);
    ...
    [Authorize(Roles = Constants.PERMISSION_VIEW_EVENT_REGISTRATIONS)]
    [ProducesResponseType(401)]
    [ProducesResponseType(403)]
    ...
    public async Task<ActionResult<Response<IList<EventRegistration>>>> GetEventRegistrations(int eventId)
    {
        try
        {
            if (!await _redisService.ValidatePermissions(Request.HttpContext.User, new string[] { Constants.PERMISSION_VIEW_EVENT_REGISTRATIONS }))
                return StatusCode(401);
    ...
    [HttpPut("Assign")]
    [Authorize(Roles = Constants.PERMISSION_ASSIGN_EVENT_REGISTRATIONS)]
    [ProducesResponseType(401)]
    [ProducesResponseType(403)]
    [ProducesResponseType(typeof(Response<EventRegistration>), 200)]
    [ProducesResponseType(typeof(Response<string?>), 404)]
    ...
    public async Task<ActionResult<Response<EventRegistration>>> AssignEventRegistration(int eventRegistrationId)
    {
        try
        {
            if (!await _redisService.ValidatePermissions(Request.HttpContext.User, new string[] { Constants.PERMISSION_ASSIGN_EVENT_REGISTRATIONS }))
                return StatusCode(401);
